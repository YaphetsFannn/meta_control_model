...
if __name__ == "__main__":
    ...
    if load_raw_data:
        ...
        outputs_file =  "/home/pku-hr6/yyf_ws/data/coeff.txt"
        ...
        files = "/home/pku-hr6/yyf_ws/data/coeff.txt"
    ...
    for i in range(3):
        ...
        x = mat(coeff_[i]).reshape(y.shape[0],-1)
        ...
        coeff_grad, loss_grad = gradient_decent(x,y,np.array(coeff_init[i]),1e-3,50)
        print("coeff grad is:")
        print(coeff_grad)
        print("loss grad is:")
        print(loss_grad)
